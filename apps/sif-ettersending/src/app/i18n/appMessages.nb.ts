...
export const appMessagesNB = {
    ...
    'modal.minePlikter.part2': 'Jeg har lest og forstått det som står på <Lenke>nav.no/rettogplikt</Lenke>.',
    ...
    'formPart.registrertBarn.hvilketBarn.født': 'Født {dato}',
    ...
    'formPart.registrertBarn.gjelderAnnetBarn': 'Ettersendelse gjelder et annet barn',
    'formPart.annetBarn.tittel': 'Annet barn',
    ...
    'steg.oppsummering.barn.spm': 'Hvilket barn gjelder ettersendelsen?',
    ...
    'steg.oppsummering.validering.manglerVedlegg': 'Det er ikke lastet opp noen vedlegg.',
