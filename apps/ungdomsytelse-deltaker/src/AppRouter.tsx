                        ...
                        <Alert variant="warning" fullWidth={true} className="w-full">
                            ...
                            <ReadMore header="Mer informajson" size="small">
                                <List>
                                    ...
                                    <List.Item>
                                        Demoen husker midlertidig det du gjør, slik at den oppfører seg som for en
                                        faktisk deltaker – for eksempel vil oppgaver du har besvart vises som besvart
                                        etterpå.
                                    </List.Item>
                                    <List.Item>Når du bytter scenario, tilbakestilles alt du har gjort.</List.Item>
                                </List>
                            </ReadMore>
                        </Alert>
                    </PageBoundary>
