    ...
    return (
        <BlueBox>
            <Heading level="2" size="medium" spacing={true}>
                Oppgave: Bekreft endret startdato
            </Heading>
            <VStack gap="4">
                <BodyShort>
                    Veileder har endret din startdato for ungdomsprogrammet til{' '}
                    <strong>
                        {oppgave.oppgavetypeData.nyStartdato
                            ? dateFormatter.dayDateMonthYear(oppgave.oppgavetypeData.nyStartdato)
                            : 'TODO'}
                    </strong>
                    . Du må bekrefte at din periode i programmet nå skal gjelde fra og med denne datoen.
                </BodyShort>
                <VStack gap="1">
