const nb = {
    ...
    'oppgavetype.BEKREFT_ENDRET_STARTDATO.tittel': 'Ny startdato i ungdomsprogrammet',
    'oppgavetype.BEKREFT_ENDRET_STARTDATO.forstårOppgaveSpørsmål': 'Forstår og godtar du at startdatoen din er endret',

    'oppgavetype.BEKREFT_ENDRET_SLUTTDATO.tittel': 'Ny sluttdato i ungdomsprogrammet',
    'oppgavetype.BEKREFT_ENDRET_SLUTTDATO.forstårOppgaveSpørsmål': 'Forstår og godtar du at sluttdatoen din er endret',

    'oppgavetype.BEKREFT_START_OG_SLUTTDATO_ENDRET.tittel': 'Ugyldig oppgave',
    'oppgavetype.BEKREFT_START_OG_SLUTTDATO_ENDRET.forstårOppgaveSpørsmål':
        'Ugyldig oppgave - start og sluttdato endret',

    'oppgavetype.BEKREFT_NY_SLUTTDATO.tittel': 'Ny sluttdato i ungdomsprogrammet',
