    ...
    deltakelser: [
        {
            ...
            forlengetPeriodeMaksDato: dateToISODate(getMockDatoer().kvoteMaksDato),
    ...
    deltakelser: [
        {
            ...
            kvoteMaksDato: dateToISODate(getMockDatoer().kvoteMaksDato),
            harForlengetPeriode: false,
            forlengetPeriodeMaksDato: dateToISODate(dayjs(getMockDatoer().deltakelseFraOgMed).add(1, 'year').toDate()),
        } satisfies DeltakelseDto,
    ],
    oppgaver,
});
