...
export const omBarnetMessages: MessageFileFormat = {
    nb: {
        ...
        'steg.omBarnet.pageTitle': 'Opplæringspengersoknad - opplysninger om barnet',
        ...
        'steg.omBarnet.alert.ikkeKroniskSykdom': 'Søknad om opplæringspenger gjelder kun for de som har barn med ...',
