...
// filters
export const isEmpty = (data: ResultView<unknown>): data is Empty =>
  data._tag === "Empty";
export const isNoValidChildrenOrange = (
  data: ResultView<unknown>
): data is NoValidChildrenOrange => data._tag === "NoValidChildrenOrange";
export const isResultBox = <A>(data: ResultView<A>): data is ResultBox<A> =>
  data._tag === "ResultBox";
