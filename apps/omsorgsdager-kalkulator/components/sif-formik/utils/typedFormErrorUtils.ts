...
import { TypedFormikFormContextType } from "../typed-formik-form/TypedFormikForm";
...
export const getErrorPropForFormikInput = ({
  ...
  return (
    error ||
    (context ? context.getAndRenderFieldErrorMessage(field, form) : undefined)
  );
};
