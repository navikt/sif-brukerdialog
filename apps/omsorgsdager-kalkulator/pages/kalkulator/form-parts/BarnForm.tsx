...
const BarnFormPart: React.FC<Props> = ({
  barn,
  index,
  antallBarn,
  openPanel,
            ...
            <>
              <div className="mt-7">
                <YesOrNoQuestion
                  ...
                  description={
                    <ReadMore
                      header={formatMessage("barn.kroniskSykt.readMore.title")}
                    >
              ...
              <div className="mt-7">
                <YesOrNoQuestion
                  ...
                  description={
                    <ReadMore
                      header={formatMessage("barn.borSammen.readMore.title")}
                    >
