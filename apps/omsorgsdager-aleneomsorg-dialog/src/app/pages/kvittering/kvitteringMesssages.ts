const nb = {
    ...
    'kvittering.info.3.1': 'Når søknaden er ferdigbehandlet, får du et svar fra oss på «Min side».',
    'kvittering.info.3.2.lenke': 'Du kan sjekke saksbehandlingstiden her.',
};
