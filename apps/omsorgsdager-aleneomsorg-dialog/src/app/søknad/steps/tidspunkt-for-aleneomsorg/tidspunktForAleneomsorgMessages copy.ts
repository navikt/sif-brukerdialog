...
const nn: Record<keyof typeof nb, string> = {
    'step.tidspunktForAleneomsorg.stepIntro':
        'No treng vi å vite når du vart aleine om omsorga for barn. Om du vart aleine om omsorga tidlegare enn i fjor, treng vi ikkje å vite konkret dato.',
    'step.tidspunktForAleneomsorg.info': 'Oppgi tidspunkt for når du vart aleine om omsorga',
    'step.tidspunktForAleneomsorg.spm': 'Kva år vart du aleine om omsorga for {navn}?',
    'step.tidspunktForAleneomsorg.radioPanelGroupLabel.siste2årene': 'I {yearAgo} eller {yearNow}',
    'step.tidspunktForAleneomsorg.radioPanelGroupLabel.tidligere': 'I {twoYearsAgo} eller tidlegare',
    'step.tidspunktForAleneomsorg.siste2årene.dato.spm': 'Kva dato vart du aleine om omsorga for {navn}?',
    'step.tidspunktForAleneomsorg.nextButtonLabel': 'Fortsett',

    'validation.tidspunktForAleneomsorg.noValue': 'Du må oppgi kva år du vart aleine om omsorga for barnet.',
    'validation.tidspunktForAleneomsorg.dato.dateHasNoValue':
        'Du må oppgi kva dato du vart aleine om omsorga for barnet.',
    ...
    'validation.tidspunktForAleneomsorg.dato.dateHasInvalidFormat':
        'Datoen når du vart aleine om omsorga for barnet er ugyldig. Gyldig format er dd.mm.åååå.',
};
