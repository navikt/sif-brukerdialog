...
const arbeidIPeriodeMessages = {
    nb: {
        ...
        'arbeidIPeriode.prosentAvNormalt.spm': 'Hvor mange prosent av normalt {timerNormalt} jobber du {dagerTekst}?',
        'arbeidIPeriode.timerAvNormalt.spm': 'Hvor mange timer av normalt {timerNormalt} jobber du {dagerTekst}?',
