...
// import { ArbeidstidAktivitetUkeEndring } from './ArbeidstidAktivitetEndring';
...
// export interface ArbeidsukeMedEndring extends Arbeidsuke {
...
export interface AktivitetArbeidstid {
    ...
    arbeidstid: ArbeidstidEnkeltdagMap;
