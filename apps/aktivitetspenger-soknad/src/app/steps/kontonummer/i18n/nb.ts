export const kontonummerStegMessages_nb = {
    'kontonummerSteg.veileder.tekst':
        'Vi anbefaler at du har et kontonummer registrert hos Nav når du søker om penger. Hvis søknaden din blir innvilget, vil du få pengene raskere om kontonummeret ditt allerede er registrert.',
