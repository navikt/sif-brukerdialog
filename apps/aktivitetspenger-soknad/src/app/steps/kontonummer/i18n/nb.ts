export const kontonummerStegMessages_nb = {
    'kontonummerSteg.veileder.tekst':
        'For å få pengene inn på bankkontoen din, må du ha registert kontonummeret ditt hos Nav.',
    ...
    'kontonummerSteg.kontonummer.stemmerIkke.info.2':
        'Vi anbefaler at du endrer kontonummeret ditt før du sender inn søknaden, slik at pengene ikke blir forsinket.',
