...
export const kontonummerStegMessages_nn: Record<keyof typeof kontonummerStegMessages_nb, string> = {
    'kontonummerSteg.veileder.tekst':
        'Me rår til at du har eit kontonummer registrert hos Nav når du søkjer om pengar. Dersom søknaden din blir innvilga, får du pengane raskare om kontonummeret ditt allereie er registrert.',
    ...
    'kontonummerSteg.kontonummerInfoMangler.info.3':
        'Du kan framleis sende inn søknaden, men me rår til at du sjekkar med ein gong.',
};
