...
export const kontonummerStegMessages_nn: Record<keyof typeof kontonummerStegMessages_nb, string> = {
    'kontonummerSteg.veileder.tekst':
        'Me tilrår at du har eit kontonummer registrert hos Nav når du søkjer om pengar. Dersom søknaden din blir innvilga, får du pengane raskare om kontonummeret ditt allereie er registrert.',
    ...
    'kontonummerSteg.kontonummer.stemmerIkke.info.2':
        'Me tilrår at du endrar kontonummeret ditt før du sender inn søknaden.',
    ...
    'kontonummerSteg.kontonummerInfoMangler.info.3':
        'Du kan framleis sende inn søknaden, men me tilrår at du sjekkar før du sender inn.',
};
