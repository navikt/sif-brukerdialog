export { BarnSteg } from './barn/BarnSteg';
export { BostedSteg } from './bosted/BostedSteg';
...
export { StartdatoOgAndreYtelserSteg } from './startdato-og-andre-ytelser/StartdatoOgAndreYtelserSteg';
