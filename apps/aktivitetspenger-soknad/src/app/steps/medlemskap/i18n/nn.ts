...
export const medlemskapStegMessages_nn: Record<keyof typeof medlemskapStegMessages_nb, string> = {
    ...
    'medlemskapSteg.spørsmål.harBoddINorge': 'Har du budd samanhengande i Noreg dei fem siste åra?',
    'medlemskapSteg.spørsmål.harBoddINorge.readMore.tittel': 'Kva betyr dette?',
    'medlemskapSteg.spørsmål.harBoddINorge.readMore.tekst':
        'Å ha «budd samanhengande» betyr at du har budd i Noreg mesteparten av tida i kvart av dei siste fem åra. ',
    'medlemskapSteg.spørsmål.harJobbetINorge': 'Har du jobba samanhengande i Noreg dei siste fem åra? ',
    'medlemskapSteg.spørsmål.harJobbetINorge.readmore.title': 'Kva betyr dette?',
    'medlemskapSteg.spørsmål.harJobbetINorge.readmore.text.1':
        'Å ha «jobba samanhengande» betyr at du har hatt ein jobb med inntekt i Noreg mesteparten av tida i kvart av dei siste fem åra.',
    ...
    'medlemskapSteg.spørsmål.harJobbetUtenforNorge': 'Har du jobba utanfor Noreg dei fem siste åra?',
    'medlemskapSteg.spørsmål.harJobbetUtenforNorge.readmore.title': 'Kva betyr dette?',
    'medlemskapSteg.spørsmål.harJobbetUtenforNorge.readmore.text':
        'Å ha «jobba utanfor Noreg» betyr at du har hatt ein jobb med inntekt i eit anna land eller fått ytingar frå styresmaktene i eit anna land som skal erstatte inntekt.',
    'medlemskapSteg.bosteder.tittel': 'Utanlandsopphald dei siste fem åra',
    'medlemskapSteg.bosteder.info.1':
        'Oppgi i kva periodar og land du har budd, studert eller jobba utanfor Noreg dei siste fem åra.',
    'medlemskapSteg.bosteder.leggTil': 'Legg til utanlandsopphald',
    'medlemskapSteg.arbeidsstederUtenforNorge.tittel': 'Jobb utanfor Noreg dei siste fem åra',
    'medlemskapSteg.arbeidsstederUtenforNorge.info.1':
        'Oppgi i kva periodar og land utanfor Noreg du har jobba dei fem siste åra.',
