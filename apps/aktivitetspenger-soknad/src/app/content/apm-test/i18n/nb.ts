export const apmTestPageMessages_nb = {
    ...
    'page.apmTest.logg.uncaughtException': 'Kaster uncaught exception (siden krasjer — reload nødvendig)',
    'page.apmTest.logg.uncaughtPromiseRejection': 'Kaster uncaught promise rejection',
};
