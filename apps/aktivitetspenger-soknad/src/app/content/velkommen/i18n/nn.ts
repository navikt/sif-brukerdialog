...
export const velkommenPageMessages_nn: Record<keyof typeof velkommenPageMessages_nb, string> = {
    ...
    'page.velkommen.omSøknaden.2':
        'Me held på svara dine i 72 timar. Om du er innanfor den tida til dømes vil ta ein pause eller blir automatisk logga ut, held du fram der du var når du kjem tilbake.',
    'page.velkommen.omSøknaden.3': 'Du må svare på alle spørsmåla for å kunne gå vidare.',
    'page.velkommen.personopplysninger.tittel': 'Korleis me hentar og handsamar personopplysningar',
    'personopplysninger.1':
        'Me hentar inn opplysningar om deg for å handsama saka di og vurdere om du har rett til aktivitetspengar, og kor mykje du kan få. Delar av saka di blir handsama automatisk.',
    'personopplysninger.2': 'Opplysningar me hentar inn og bruker i handsaminga',
