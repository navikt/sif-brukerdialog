export const velkommenPageMessages_nb = {
    'page.velkommen.sidetittel': 'Søknad om aktivitetspenger',
    'page.velkommen.guide.tittel': 'Hei {navn}',
    'page.velkommen.guide.ingress': 'Velkommen til søknad om aktivitetspenger.',

    'page.velkommen.guide.info.1': 'Her kan du søke om aktivitetspenger.',
    ...
    'page.velkommen.personopplysninger.tittel': 'Hvordan vi henter og behandler personopplysninger',
    'personopplysninger.1':
        'Vi henter inn opplysninger om deg for å behandle saken din og vurdere om du har rett til aktivitetspenger, og hvor mye du kan få. Deler av saken din blir behandlet automatisk.',

    'personopplysninger.2': 'Opplysninger vi henter inn og bruker i behandlingen',
    'personopplysninger.2.1':
        'Alderen din hentes fra folkeregisteret og brukes til å vurdere om du oppfyller søknadsvilkåret om alder.',
    'personopplysninger.2.2':
        'Fødselsdatoen din hentes fra folkeregisteret og brukes til å vurdere hvor høy minstesats du kan få.',
    'personopplysninger.2.3':
        'Opplysninger om tidligere inntekt hentes fra Skatteetaten og brukes til å vurdere hvor mye du kan få i aktivitetspenger.',
    'personopplysninger.2.4':
        'Antall barn du har og deres fødselsdato hentes fra folkeregisteret og brukes til å vurdere om og hvor mye du kan få i barnetillegg.',

    'personopplysninger.3': 'Hver måned henter vi i tillegg disse opplysningene om deg:',
    'personopplysninger.3.1':
        'Inntekten din fra forrige måned hentes fra a-ordningen og brukes til å vurdere hvor mye du kan få i aktivitetspenger.',
    ...
    'page.velkommen.regler.tekst.1':
        'Når Nav behandler søknaden din og vurderer om du har rett til aktivitetspenger, så er det disse rettsreglene som gjelder: LOVER OG FORSKRIFTER.',
