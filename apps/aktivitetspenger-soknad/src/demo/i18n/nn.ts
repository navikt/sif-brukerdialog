import { scenarioHeaderMessages_nb } from './nb';

export const scenarioHeaderMessages_nn: Record<keyof typeof scenarioHeaderMessages_nb, string> = {
    'scenarioHeader.tittel': 'Demo av søknad om aktivitetspengar',
    'scenarioHeader.inngangsscenarioer': 'Inngangsscenario',
    'scenarioHeader.førstegangssøknad': 'Førstegongssøknad',
    ...
    'scenarioHeader.ingenRegistrerteBarn': 'Ingen registrerte barn',
};
