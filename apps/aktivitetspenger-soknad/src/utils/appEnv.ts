...
export const getAppEnv = (): AppEnv => ({
    ...
    [AppEnvKey.SIF_PUBLIC_URL_SKATTEKORT]: getRequiredEnv(AppEnvKey.SIF_PUBLIC_URL_SKATTEKORT),
    [AppEnvKey.SIF_PUBLIC_URL_LOVDATA_INNTEKT]: getRequiredEnv(AppEnvKey.SIF_PUBLIC_URL_LOVDATA_INNTEKT),
