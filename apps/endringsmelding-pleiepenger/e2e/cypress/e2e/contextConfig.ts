...
export const contextConfig = (props?: ConfigProps) => {
    ...
    beforeEach('intercept mellomlagring og levere tomt objekt', () => {
        ...
        cy.intercept(`/oppslag/arbeidsgiver?ytelse=endringsmelding-pleiepenger`, arbeidsgivereMock);
        cy.intercept(`/oppslag/soker?ytelse=endringsmelding-pleiepenger`, søkerMock);
