export const sifCommonPleiepengerMessages_nb = {
    ...
    'tidEnkeltdagForm.gjentagelse.delAvMåned': 'Alle dager søkt for i {månedNavn}',
    ...
    'tidEnkeltdagForm.gjentagelse.sammeDagUtSøknadsperiodenFom':
        'Alle {dagerNavn} i hele søknadsperioden, fra og med {fra}',
    'tidEnkeltdagForm.gjentagelse.alleDagerUtSøknadsperioden': 'Alle dager i hele søknadsperioden, fra og med {fra}',
    'tidEnkeltdagForm.gjentagelse.separator.alleUkedager': 'Alle dager',
    'tidEnkeltdagForm.gjentagelse.separator.alleSammeDag': 'Alle {dagnavn}',
