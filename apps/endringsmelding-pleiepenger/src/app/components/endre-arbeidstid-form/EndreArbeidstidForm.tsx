import { Alert, BodyShort, Heading, Ingress, Tag, ToggleGroup } from '@navikt/ds-react';
...
import { getDagerMedFerieTekst, getFeriedagerIUke } from '../arbeidstid-uke-liste/ArbeidstidUkeTabell';
