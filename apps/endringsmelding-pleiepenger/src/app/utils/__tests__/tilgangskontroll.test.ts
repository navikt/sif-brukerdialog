import { ArbeidsgiverMedAnsettelseperioder, K9SakArbeidstaker, K9SakArbeidstidPeriodeMap } from '@app/types';
...
const arbeidsgiverUkjentMedÉnAnsettelsesperiode: ArbeidsgiverMedAnsettelseperioder = {
    key: 'a_5',
    navn: 'a_5',
    ansettelsesperioder,
...
describe('harFlereAnsettelsesforholdHosUkjentArbeidsgiver', () => {
    ...
    it('returnerer false hvis arbeidsgiver ikke har arbeidsaktivitet i sak men har kun én ansettelseperiode', () => {
        const result = tilgangskontrollUtils.harFlereAnsettelsesforholdHosUkjentArbeidsgiver(
            [arbeidsgiverUkjentMedÉnAnsettelsesperiode],
            [arbeidstaker1, arbeidstaker2],
        );
        expect(result).toBeFalsy();
    });
