...
export const samtykkeFormOverrideMessages: MessageFileFormat = {
    nb: {
        ...
        'samtykkeForm.ansvar.tittel': 'Ditt ansvar når du sender inn en endring',
        'samtykkeForm.ansvar.list.1':
            'Jeg forstår at hvis jeg gir uriktige opplysninger, kan det få konsekvenser for retten min til det jeg sender endring om',
