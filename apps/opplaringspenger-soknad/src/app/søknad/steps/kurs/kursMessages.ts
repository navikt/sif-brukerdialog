const nb = {
    ...
    'steg.kurs.validation.reisedager.reisedagUtenforKursperiode':
        '{antallDager, plural, one {Én reisedag} other {# reisedager}} er ikke innenfor dagene du søker. Dette kan skje hvis du har endrer hvilke dager du søker opplæringspenger, etter at du har lagt til reisedag. Du må endre eller fjerne reisedag som ikke er innenfor dager du søker. Reisedager utenfor søknadsperiode: {dager}.',
    'steg.kurs.validation.ferieuttak.ferieperiodeUtenforKursperiode':
        'Ferie er ikke innenfor dagene du søker. Dette kan skje hvis du har endrer hvilke dager du søker opplæringspenger, etter at du har lagt til ferie. Du må endre eller fjerne ferie som ikke er innenfor dager du søker. Feriedager utenfor søknadsperiode: {dager}.',
...
const nn: Record<keyof typeof nb, string> = {
    ...
    'steg.kurs.validation.reisedager.listIsEmpty':
        'Du har krysset av for at du reiser på dagar du ikkje har kurs eller opplæring, då må du legge til minst éin dag med reise.',
    'steg.kurs.validation.reisedagerBeskrivelse.stringHasNoValue':
        'Du må beskrive kvifor du reiser på andre dagar enn du har kurs eller opplæring.',
    'steg.kurs.validation.reisedagerBeskrivelse.stringIsTooShort':
    ...
    'steg.kurs.reisedagerFormPart.modal.listTitle': 'Reise på dagar du ikkje har kurs eller opplæring',
    'steg.kurs.reisedagerFormPart.modal.modalDescription':
