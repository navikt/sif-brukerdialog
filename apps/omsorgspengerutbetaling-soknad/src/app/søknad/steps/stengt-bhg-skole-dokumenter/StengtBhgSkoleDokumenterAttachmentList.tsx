...
const StengtBhgSkoleDokumenterAttachmentList: React.FC<Props> = ({
    wrapNoAttachmentsInBlock,
    includeDeletionFunctionality,
}) => {
    const { values, setFieldValue } = useFormikContext<StengtBhgSkoleDokumenterFormValues>();
        ...
        return (
            <AttachmentListWithDeletion
                ...
                onRemoveAttachmentClick={(attachment: Attachment) => {
                    ...
                    setFieldValue(StengtBhgSkoleDokumenterFormFields.vedlegg, avtale);
                    const updateFieldValue = () => {
                        setFieldValue(
                            StengtBhgSkoleDokumenterFormFields.vedlegg,
...
export default StengtBhgSkoleDokumenterAttachmentList;
