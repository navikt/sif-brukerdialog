...
export const dineBarnMessages: MessageFileFormat = {
    nb: {
        ...
        'step.dineBarn.counsellorPanel.avsnitt.1':
        ...
        'step.dineBarn.counsellorPanel.avsnitt.2':
        ...
        'step.dineBarn.annetBarnListAndDialog.listTitle': 'Barn du har lagt til',
        ...
        'step.dineBarn.harFåttEkstraOmsorgsdager.nei.alertStripe':
        ...
        'step.dineBarn.utvidetRettFor.spm': 'Kryss av for barn du har fått ekstra omsorgsdager for:',
        ...
        'step.dineBarn.info.spm.andreBarn': 'Har du barn som ikke er registrert her?',
        'step.dineBarn.info.spm.flereBarn': 'Har du flere barn som ikke er registrert her?',
