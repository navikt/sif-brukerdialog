import { dineBarnMessages_nb } from './nb';

export const dineBarnMessages_nn: Record<keyof typeof dineBarnMessages_nb, string> = {
    'step.dineBarn.nextButtonLabel': 'Fortset',
    'step.dineBarn.intro.1':
        'Sjølvstendig næringsdrivande og frilansarar må som hovudregel sjølv dekke 10 omsorgsdagar kvart kalenderår. Dersom du har rett til meir enn 10 omsorgsdagar, kan du søkje om utbetaling frå Nav frå den 11. dagen du er heime med sjukt barn.',
    ...
    'step.dineBarn.bekrefterDektTiDagerSelv.info.tekst':
        'Du skal dekke dei 10 første omsorgsdagane sjølv, og kan søkje om utbetaling frå Nav frå den 11. dagen du er heime med sjukt barn.',

    'step.dineBarn.info.spm.text':
        'Dersom du har barn som ikkje er registrert her, kan du leggje inn desse sjølv. Det kan til dømes vere fosterbarn.',
