...
import StengtBhgSkoleDokumenterStep from './steps/stengt-bhg-skole-dokumenter/StengtBhgSkoleDokumenterStep';
...
const SøknadRouter = () => {
    ...
    return (
        <Routes>
            ...
            />
            <Route
                path={SøknadStepRoutePath[StepId.DOKUMENTER_STENGT_SKOLE_BHG]}
                element={<StengtBhgSkoleDokumenterStep />}
            />
