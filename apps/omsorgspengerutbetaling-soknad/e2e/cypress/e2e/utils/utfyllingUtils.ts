...
const fraDato = dayjs().startOf('week').subtract(3, 'weeks').format('DD.MM.YYYY');
const tilDato = dayjs().format('DD.MM.YYYY');
const datoDelvisFravær = dayjs().startOf('week').subtract(4, 'weeks').format('DD.MM.YYYY');
const fomDatoIUtlandet = dayjs().startOf('week').subtract(3, 'weeks').add(2, 'day').format('DD.MM.YYYY');
const tomDatoIUtlandet = dayjs().startOf('week').subtract(3, 'weeks').add(4, 'day').format('DD.MM.YYYY');
const frilansStartDato = dayjs().startOf('week').subtract(10, 'weeks').format('DD.MM.YYYY');
