...
describe('PleietrengendeSchema', () => {
    ...
    describe('Ikke-anonymisert pleietrengende', () => {
        it('skal sette anonymisert=false når fornavn og etternavn finnes', () => {
            const result = PleietrengendeSchema.parse({
                ...baseData,
                fornavn: 'Ola',
                mellomnavn: 'Andreas',
                etternavn: 'Nordmann',
    ...
    describe('Anonymisert pleietrengende', () => {
        ...
        it('skal sette anonymisert=true og fjerne navn-felter når de mangler', () => {
            const result = PleietrengendeSchema.parse(baseData);
    ...
    describe('Type guards', () => {
        it('skal ha riktige TypeScript-typer basert på anonymisert-flagget', () => {
            const ikkeAnonymisert = PleietrengendeSchema.parse({
                ...baseData,
                fornavn: 'Ola',
                etternavn: 'Nordmann',
            });

            const anonymisert = PleietrengendeSchema.parse(baseData);
