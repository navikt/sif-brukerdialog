...
export default defineConfig(({ mode }) => ({
    ...
    resolve: {},
    base: mode === 'production' ? 'https://cdn.nav.no/dusseldorf/omsorgspengerutbetaling-arbeidstaker-soknad/dist/' : '/familie/sykdom-i-familien/soknad/omsorgspengerutbetaling-arbeidstaker/',
    build: {
