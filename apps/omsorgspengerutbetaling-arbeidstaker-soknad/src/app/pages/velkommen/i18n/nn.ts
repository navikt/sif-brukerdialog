...
export const velkommenPageMessages_nn: Record<keyof typeof velkommenPageMessages_nb, string> = {
    'page.velkommen.sidetittel': 'Søknad om utbetaling av omsorgspengar',
    'page.velkommen.guide.tittel': 'Hei {navn}',
    'page.velkommen.guide.ingress': 'Velkomen til søknad om omsorgspengar.',
    ...
    'page.velkommen.guide.tekst.2':
        'I tillegg til å søkje må du be arbeidsgjevar om å sende inntektsmelding til oss så snart du har sendt søknaden. Me må ha den for å kunne handsame søknaden din.',
    ...
    'page.velkommen.form.ansvar.list.1':
        'Eg forstår at dersom eg gjev uriktige opplysningar, kan det få konsekvensar for retten min til det eg søkjer om',
    ...
    'personopplysninger.2':
        'Me innhentar og mottar opplysningar om deg for å handsame saka di. Det er naudsynt for at du skal få rett teneste. Deler av saka di blir handsama automatisk.',
    'personopplysninger.3': 'Kva opplysningar innhentar me?',
    'personopplysninger.4': 'Opplysningane me innhentar kjem anten frå deg eller frå offentlege register:',
