...
export const oppsummeringMessages: MessageFileFormat = {
    nb: {
        ...
        'step.oppsummering.dineBarn': 'Fosterbarn',
        'step.oppsummering.dineBarn.harFosterbarn': 'Har du fosterbarn?',
        ...
        'step.oppsummering.utenlandsoppholdIPerioden.listetittel':
            'Utenlandsopphold i perioden du har brukt omsorgsdager',
