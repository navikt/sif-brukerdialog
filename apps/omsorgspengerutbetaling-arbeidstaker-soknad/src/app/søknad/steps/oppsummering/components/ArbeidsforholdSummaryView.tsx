                ...
                return (
                    <Block key={index} margin="l">
                        ...
                        <div className={'arbeidsforholdSummaryContent'}>
                            <Block margin={'s'}>
                                <SummaryBlock header={text('step.oppsummering.arbeidsforhold.harHattFravær.spm')}>
                            ...
                            <Block margin={'s'}>
                                <SummaryBlock header={text('step.oppsummering.arbeidsforhold.utbetalingsårsak.spm')}>
                                    <AppText
                            ...
                            {arbeidsforhold.utbetalingsårsak === Utbetalingsårsak.nyoppstartetHosArbeidsgiver &&
                                arbeidsforhold.årsakNyoppstartet && (
                                    <Block margin={'s'}>
                                        <SummaryBlock
                                            header={text('step.oppsummering.arbeidsforhold.årsakMinde4Uker.spm')}>
                                            <AppText
                            ...
                            {arbeidsforhold.utbetalingsårsak === Utbetalingsårsak.konfliktMedArbeidsgiver && (
                                <Block margin={'s'}>
                                    <Block margin={'s'}>
                                        <SummaryBlock
                                            header={text('step.oppsummering.arbeidsforhold.konflikt.forklaringTittel')}>
                                            <p>{arbeidsforhold.konfliktForklaring}</p>
                                        </SummaryBlock>
                                    </Block>
                                    <SummaryBlock
                                        header={text('step.oppsummering.arbeidsforhold.konflikt.dokumenter.header')}>
