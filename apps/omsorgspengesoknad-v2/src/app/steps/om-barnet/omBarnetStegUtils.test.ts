...
import { getMinDatoForBarnetsFødselsdato, isBarnOver18år } from './omBarnetStegUtils';
...
describe('isBarnOver18år', () => {
    ...
    it('should return false if the person is 18 years old and today is before April 1 (15 February) of the following year', () => {
