...
export const velkommenPageMessages_nn: Record<keyof typeof velkommenPageMessages_nb, string> = {
    ...
    'page.velkommen.guide.ingress':
        'Velkomen til søknad om ekstra omsorgsdagar når den andre forelderen ikkje kan ha tilsyn med barn.',
    'page.velkommen.guide.tekst.1':
        'Denne søknaden er for deg som skal søkje om ekstra omsorgsdagar fordi den andre forelderen ikkje kan ha tilsyn med barn i ein periode som varer i minst 6 månadar. Dette er i situasjonar der den andre forelderen til dømes',
    'page.velkommen.guide.tekst.1.1': 'er fysisk eller psykisk sjuk',
    'page.velkommen.guide.tekst.1.2': 'er innlagd i helseinstitusjon',
    'page.velkommen.guide.tekst.1.3': 'har ei funksjonshemming',
    ...
    'personopplysninger.2':
        'Me innhentar og mottek opplysningar om deg når me skal handsame saka di. Det er naudsynt for at du skal få riktig teneste. Saka di kan bli handsama automatisk.',
