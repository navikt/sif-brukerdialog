...
export const annenForelderenSituasjonMessages: MessageFileFormat = {
    nb: {
        ...
        'step.annenForeldrensSituasjon.periode.INNLAGT_I_HELSEINSTITUSJON.spm':
            'I hvilken periode gjelder innleggelsen?',
