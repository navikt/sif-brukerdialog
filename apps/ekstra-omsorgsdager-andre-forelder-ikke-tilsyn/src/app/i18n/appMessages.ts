...
export const appMessages: MessageFileFormat = {
    nb: {
        ...
        'step.omAnnenForelder.pageTitle':
            'Om den andre forelderen - Søknad om ekstra omsorgsdager når den andre forelderen ikke kan ha tilsyn med barn',
        'step.omAnnenForelder.stepTitle': 'Om den andre forelderen',

        'step.annenForelderSituasjon.pageTitle':
            'Den andre forelderens situasjon - Søknad om ekstra omsorgsdager når den andre forelderen ikke kan ha tilsyn med barn',
        'step.annenForelderSituasjon.stepTitle': 'Den andre forelderens situasjon',

        'step.omBarna.pageTitle':
            'Om barn - Søknad om ekstra omsorgsdager når den andre forelderen ikke kan ha tilsyn med barn',
        'step.omBarna.stepTitle': 'Om barn',

        'step.oppsummering.pageTitle':
            'Oppsummering - Søknad om ekstra omsorgsdager når den andre forelderen ikke kan ha tilsyn med barn',
