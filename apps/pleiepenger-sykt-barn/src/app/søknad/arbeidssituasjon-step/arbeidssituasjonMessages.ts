...
const nn: Record<keyof typeof nb, string> = {
    ...
    'steg.arbeidssituasjon.stønadGodtgjørelse.starterUndeveis.spm':
        'Startar stønaden eller godtgjersla undervegs i pleiepengeperioden din?',
    'steg.arbeidssituasjon.stønadGodtgjørelse.starterUndeveis.startdato': 'Startdato:',
    'steg.arbeidssituasjon.stønadGodtgjørelse.slutterUndeveis.spm':
        'Stoppar stønaden eller godtgjersla undervegs i pleiepengeperioden din?',
    'steg.arbeidssituasjon.stønadGodtgjørelse.starterUndeveis.sluttdato': 'Sluttdato:',
    ...
    'arbeidsforhold.ikkeAnsatt.info':
        'Når du ikkje er tilsett her lenger, må du be denne arbeidsgivaren om å sende ei ny A-melding med sluttdato. Dette gjer dei anten via eige lønns- og personalsystem, eller via Altinn.',
    ...
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS.info.2':
        'Viss dei siste 12 vekene ikkje er representative for kor mykje du jobbar som frilanser, må du ta utgangspunkt i ein så lang periode som er representativ for deg.',
    'arbeidsforhold.frilanser.normalTimer.frilans.HONORAR.info.1':
        'Du reknar ut eit snitt ved å legge saman alle timane du har brukt på oppdraget du mottar honorar for dei siste 12 vekene, og deler dette på 12. Då får du eit snitt per veke.',
    'arbeidsforhold.frilanser.normalTimer.frilans.HONORAR.info.2':
        'Viss dei siste 12 vekene ikkje er representative i di situasjon, må du ta utgangspunkt i ein så lang periode som er representativ for deg.',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS_HONORAR.info.1':
        'Du reknar ut eit snitt ved å legge saman talet på timar du jobbar som frilanser med talet på timar du brukar på det du mottar honorar for. Legg saman timane for dei siste 12 vekene, og så deler du dette på 12. Då får du eit snitt per veke.',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS_HONORAR.info.2':
        'Viss dei siste 12 vekene ikkje er representative i di situasjon, må du ta utgangspunkt i ein så lang periode som er representativ for deg.',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS_HONORAR.info.3': 'Eksempel på korleis du reknar ut:',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS_HONORAR.info.4':
        'Du har dei siste 12 vekene jobba 40 timar som frilanser, og du har brukt 20 timar på det du mottar honorar for. Då får du til saman 60 timar, som du deler på 12 = 5. Du oppgir altså at du jobbar 5 timar i snitt per veke.',
    ...
    'selvstendig.harDuHattInntekt.hjelpetekst.snSkatteetatenLenke':
        'I tillegg kan du lese på Skatteetaten si side om andre situasjonar der du kan bli rekna som sjølvstendig næringsdrivande.',
    'selvstendig.harFlereVirksomheter.spm': 'Har du fleire enn éi næringsverksemd som er aktiv?',
    'selvstendig.veileder.flereAktiveVirksomheter':
        'Når du har fleire aktive næringsverksemder, skal du berre legge inn den verksemda som er eldst av dei. Har du for eksempel ei verksemd du starta i 2012 og ei anna som du starta i 2020, skal du berre legge inn verksemda du starta i 2012.',
    ...
    'frilanser.harDuHattInntekt.hvaBetyr.info.2':
        'Eit honorar kan for eksempel vere ei utbetaling i samband med eit styreverv eller som trenar for eit idrettslag. Honorar blir òg ofte brukt av frie yrke som forfattarar, fotografar og kunstnarar.',

    'frilanser.startetFørSisteTreHeleMåneder.spm': 'Starta du som frilanser før {dato}?',
    'frilanser.startdato.spm': 'Når starta du å jobbe som frilanser?',

    'frilanser.erFortsattFrilanser.spm': 'Jobbar du framleis som frilanser?',
    'frilanser.ingenFrilans.info':
        'Viss det ikkje stemmer at du skal vere registrert med frilansoppdrag i AA-registeret, må du be dei som har gjort registreringa om å oppdatere informasjonen. Du kan likevel fortsette å fylle ut og sende inn søknaden.',

    'frilanser.sluttdato.spm': 'Når slutta du å jobbe som frilanser?',
    'frilanser.misterHonorar.tittle': 'Mister du honorar fordi du må pleie barnet?',
    ...
    'frilanser.hjelpetekst.1':
        'Du er frilanser når du mottar lønn for enkeltståande oppdrag utan å vere fast eller mellombels tilsett hos den du utfører oppdraget for. Viss du er usikker på om du er frilanser, må du sjekke om oppdraga dine er registrerte som frilansoppdrag på Skatteetaten sine nettsider.',
    'verneplikt.summary.header': 'Verneplikt',
    'verneplikt.summary.harVærtVernepliktig': 'Utøvde verneplikt på tidspunktet det søkes pleiepenger fra',
