...
const nn: Record<keyof typeof nb, string> = {
    'step.arbeidssituasjon.pageTitle': 'Pleiepengesøknad - opplysningar om di arbeidssituasjon',
    'step.arbeidssituasjon.stepTitle': 'Arbeidssituasjonen di',
    'step.arbeidssituasjon.stepIndicatorLabel': 'Om di arbeidssituasjon',

    'steg.arbeidssituasjon.tittel': 'Arbeidsgivarar',
    'steg.arbeidssituasjon.veileder.1':
        'Nå treng me å vite litt om arbeidssituasjonen di, og kor mye du normalt jobbar. Med «normalt» mener me kor mye du jobbar når du ikkje har fravær på grunn av pleiepenger eller annet.',
    'steg.arbeidssituasjon.veileder.2':
        'Det er normalarbeidstiden di <strong>før</strong> du starter med pleiepenger som me er ute etter her, uavhengig av om du søkjer for første gang, eller om du søkjer forlengelse.',
    'steg.arbeidssituasjon.veileder.3':
        'Hvis du mottar yting fra Nav (for eksempel foreldrepengar eller sjukepengar) opplyser du om det som var di normale arbeidstid før du startet å motta ytelsen.',
    'steg.arbeidssituasjon.veileder.medArbeidsgiver':
        'Nedenfor ser du {antall, plural, one {arbeidsgiveren} other {arbeidsgivere}} du er registrert ansatt hos i AA-registeret i perioden du søkjer om pleiepenger. For at me skal være sikre på at opplysningene er riktige må du bekrefte om du er, eller har vært, ansatt der.',
    'steg.arbeidssituasjon.veileder.ingenArbeidsgiverFunnet':
        'Me har ikkje funnet noen arbeidsgivarar registrert på deg i AA-registeret.',
    'steg.arbeidssituasjon.veileder.manglerDetArbeidsgiver.tittel': 'Har du arbeidsforhold som ikkje vises?',
    'steg.arbeidssituasjon.veileder.manglerDetArbeidsgiver':
    ...
    'steg.arbeidssituasjon.stønadGodtgjørelse.mottarStønadGodtgjørelse.spm.description.tittel': 'Hva betyr dette?',
    'steg.arbeidssituasjon.stønadGodtgjørelse.mottarStønadGodtgjørelse.spm.description':
        'Fosterhjemsgodtgjørelse og omsorgsstønad regnes som et frilansinntekt, og kan påvirke kor mye du får i pleiepenger. ',
    'steg.arbeidssituasjon.stønadGodtgjørelse.mottarStønadGodtgjørelseIHelePerioden.spm':
        'Mottar du denne stønaden eller godtgjørelsen gjennom hele perioden du søkjer om?',
    'steg.arbeidssituasjon.stønadGodtgjørelse.starterUndeveis.spm':
        'Starter stønaden eller godtgjørelsen underveis i pleiepengeperioden di?',
    'steg.arbeidssituasjon.stønadGodtgjørelse.starterUndeveis.startdato': 'Startdato:',
    'steg.arbeidssituasjon.stønadGodtgjørelse.slutterUndeveis.spm':
        'Stopper stønaden eller godtgjørelsen underveis i pleiepengeperioden di?',
    'steg.arbeidssituasjon.stønadGodtgjørelse.starterUndeveis.sluttdato': 'Sluttdato:',

    'steg.arbeidssituasjon.frilanser.tittel': 'Frilans og oppdrag som regnes som frilansoppdrag',
    'steg.arbeidssituasjon.sn.tittel': 'Selvstendig næringsdrivande',

    'steg.arbeidssituasjon.opptjeningUtland.tittel': 'Jobbet i et annet EØS-land',
    'steg.arbeidssituasjon.opptjeningUtland.spm':
        'Har du jobba som arbeidstaker eller frilanser i et annet EØS-land i løpet av de 3 siste månedene før perioden du søkjer om?',
    'steg.arbeidssituasjon.opptjeningUtland.listAndDialog.addLabel': 'Legg til jobb i et annet EØS-land',
    'steg.arbeidssituasjon.opptjeningUtland.listAndDialog.listTitle': 'Registrert jobb i et annet EØS-land',
    'steg.arbeidssituasjon.opptjeningUtland.listAndDialog.modalTitle': 'Jobbet i et annet EØS-land',

    'steg.arbeidssituasjon.utenlandskNæring.spm':
        'Har du jobba som selvstendig næringsdrivande i et annet EØS-land i løpet av de 3 siste årene før perioden du søkjer om?',

    'steg.arbeidssituasjon.verneplikt.tittel': 'Verneplikt',
    'steg.arbeidssituasjon.verneplikt.spm': 'Utøvde du verneplikt på tidspunktet du søkjer pleiepenger fra?',
    'steg.arbeidssituasjon.verneplikt.info.tittel': 'Hva betyr dette?',
    'steg.arbeidssituasjon.verneplikt.info.tekst':
        'Du skal svare ja på dette spørsmålet om du har utøvd verneplikt i minst 28 dagar på starttidspunktet for perioden du søkjer for, eller om perioden med verneplikt var ment å vare i minst 28 dagar.',

    'arbeidsforhold.ikkeAnsatt.info':
        'Når du ikkje er ansatt her lenger, må du be denne arbeidsgivaren om å sende en ny A-melding med sluttdato. Dette gjør de enten via eget lønns- og personalsystem, eller via Altinn.',

    'arbeidsforhold.erAnsatt.spm': 'Stemmer det at du er ansatt hos {navn} i perioden du søkjer for?',
    'arbeidsforhold.sluttetFørSøknadsperiode.spm': 'Sluttet du hos {navn} før {fraDato}?',
    'arbeidsforhold.arbeiderNormaltTimerPerUke.snitt.spm':
        'Hvor mange timer {jobber} du vanligvis {hvor}? Oppgi tiden i et snitt per uke:',
    'arbeidsforhold.arbeiderNormaltTimerPerUke.snitt.infoStønadGodtgjørelse':
        'Du skal ikkje inkludere timer for omsorgsstønad/fosterhjemgodtgjørelse.',

    'arbeidsforhold.ansatt.normalTimer.info.tittel': 'Hva om jeg jobbar turnus eller varierende?',
    'arbeidsforhold.selvstendig.normalTimer.info.tittel': 'Hva om jeg jobbar turnus eller varierende?',
    'arbeidsforhold.frilanser.normalTimer.frilans.omsorgsstønad':
        'Du skal ikkje inkludere timer for fosterhjemsgodtgjørelse og omsorgsstønad.',
    'arbeidsforhold.frilanser.normalTimer.frilans.info.tittel': 'Hvordan regner jeg et snitt?',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS.info.1':
        'Du regner ut et snitt ved å legge sammen alle timene du har jobba som frilanser de siste 12 ukene, og deler dette på 12. Da får du et snitt per uke.',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS.info.2':
        'Hvis de siste 12 veker ikkje er representativ for kor mye du jobbar som frilanser må du ta utgangspunkt i en så lang periode som er representativ for deg.',
    'arbeidsforhold.frilanser.normalTimer.frilans.HONORAR.info.1':
        'Du regner ut et snitt ved å legge sammen alle timene du har brukt på oppdraget du mottar honorar for de siste 12 ukene, og deler dette på 12. Da får du et snitt per uke.',
    'arbeidsforhold.frilanser.normalTimer.frilans.HONORAR.info.2':
        'Hvis de siste 12 ukene ikkje er representative i di situasjon, må du ta utgangspunkt i en så lang periode som er representativ for deg.',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS_HONORAR.info.1':
        'Du regner ut et snitt ved å legge sammen antall timer du jobbar som frilanser med antall timer du brukar på det du mottar honorar for. Legg sammen timene for de siste 12 ukene, og så deler du dette på 12. Da får du et snitt per uke.',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS_HONORAR.info.2':
        'Hvis de siste 12 ukene ikkje er representative i di situasjon, må du ta utgangspunkt i en så lang periode som er representativ for deg.',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS_HONORAR.info.3': 'Eksempel på hvordan du regner ut:',
    'arbeidsforhold.frilanser.normalTimer.frilans.FRILANS_HONORAR.info.4':
        'Du har de siste 12 ukene jobba 40 timer som frilanser, og du har brukt 20 timer på det du mottar honorar for. Da får du til sammen 60 timer, som du deler på 12 = 5. Du oppgir altså at du jobbar 5 timer i snitt per uke.',

    'arbeidsforhold.normalTimer.info.turnus':
        'Når du jobbar turnus, eller har annen varierende arbeidstid, oppgir du et snitt per uke.',
    'arbeidsforhold.normalTimer.info.turnus.tittel': 'Slik regner du ut et snitt når du jobbar turnus',
    'arbeidsforhold.normalTimer.info.turnus.avsnitt.1':
        'Du regner ut snittet ved å legge sammen antall timer du jobbar totalt i hele turnusperioden di, og deler det med antall veker som turnusperioden di består av.',
    'arbeidsforhold.normalTimer.info.turnus.avsnitt.2': 'Eksempel:',
    'arbeidsforhold.normalTimer.info.turnus.avsnitt.3':
        'Du har en turnus som går over 3 veker. Den første uka jobbar du 20 timer, den andre 40 timer og den tredje uka jobbar du 15 timer. Da legger du sammen antall timer du har jobba og deler med antall veker i turnusperioden di.',
    'arbeidsforhold.normalTimer.info.turnus.avsnitt.4': 'Da blir regnestykket slik i dette eksempelet:',
    'arbeidsforhold.normalTimer.info.turnus.avsnitt.4a': '20 timer + 40 timer + 15 timer = 75 timer',
    'arbeidsforhold.normalTimer.info.turnus.avsnitt.4b':
        'Så deler du antall timer med antall veker i turnusperioden di: 75 / 3 = 25',
    'arbeidsforhold.normalTimer.info.turnus.avsnitt.5':
        'Du jobbar altså i snitt 25 timer per uke, og det er dette tallet du oppgir.',

    'arbeidsforhold.normalTimer.info.varierende.tittel': 'Slik regner du ut et snitt ved varierende arbeidstid',
    'arbeidsforhold.normalTimer.info.varierende.avsnitt.1':
        'Du regner ut et snitt ved å legge sammen antall timer du totalt har jobba de siste 12 ukene og deler det med 12. Hvis du ikkje har jobba i 12 veker, regner du ut snittet på samme måte ved å bruke de ukene du har jobba.',
    'arbeidsforhold.normalTimer.info.varierende.avsnitt.2': 'Eksempel når du har jobba de siste 12 ukene:',
    'arbeidsforhold.normalTimer.info.varierende.avsnitt.3':
        'De siste 12 ukene har du jobba 250 timer. Da deler du antall timer du har jobba med 12: 250 timer / 12 veker = 20,8',
    'arbeidsforhold.normalTimer.info.varierende.avsnitt.4':
        'Du jobbar altså i snitt 20,8 timer per uke, og det er dette tallet du oppgir.',

    'arbeidsforhold.normalTimer.info.varierende.avsnitt.5':
        'Slik regner du ut et snitt når du har jobba mindre enn 12 veker:',
    'arbeidsforhold.normalTimer.info.varierende.avsnitt.6':
    ...
    'selvstendig.harDuHattInntekt.spm': 'Er du selvstendig næringsdrivande i perioden du søkjer for?',
    'selvstendig.harDuHattInntekt.hjelpetekst.tittel': 'Hva betyr det å være selvstendig næringsdrivande?',
    'selvstendig.harDuHattInntekt.hjelpetekst':
        'Du er selvstendig næringsdrivande når du enten har et enkeltpersonforetak (ENK), et ansvarlig selskap (ANS), eller et ansvarlig selskap med delt ansvar (DA).',
    'selvstendig.harDuHattInntekt.hjelpetekst.snSkatteetatenLenke':
        'I tillegg kan du lese på skatteetatens side om andre situasjoner kor du kan regnes som selvstendig næringsdrivande.',
    'selvstendig.harFlereVirksomheter.spm': 'Har du flere enn én næringsvirksomhet som er aktiv?',
    'selvstendig.veileder.flereAktiveVirksomheter':
        'Når du har flere aktive næringsvirksomheter skal du kun legge inn den virksomheten som er eldst av dem. Har du for eksempel en virksomhet du startet i 2012 og en annen som du startet i 2020, skal du kun legge inn virksomheten du startet i 2012.',
    ...
    'selvstendig.infoDialog.fjernKnapp': 'Fjern virksomhet',
    'selvstendig.infoDialog.tittel.en': 'Opplysninger om virksomheten di',
    'selvstendig.infoDialog.tittel.flere': 'Opplysninger om den eldste virksomheten di',
    ...
    'frilanser.harDuHattInntekt.hvaBetyr.spm': 'Hva betyr dette?',
    'frilanser.harDuHattInntekt.hvaBetyr.info.1':
        'Du skal svare ja på dette spørsmålet hvis du jobbar som frilanser og/eller mottar honorar for utført oppdrag. Du kan få kompensert et eventuelt tap av denne inntekten.',
    'frilanser.harDuHattInntekt.hvaBetyr.info.2':
        'Et honorar kan for eksempel være en utbetaling i forbindelse med et styreverv, eller som trener for et idrettslag. Honorar blir også ofte brukt av frie yrker som forfattere, fotografer og kunstnere.',
    ...
    'frilanser.erFortsattFrilanser.spm': 'Jobber du fortsatt som frilanser?',
    'frilanser.ingenFrilans.info':
        'Hvis det ikkje stemmer at du skal være registrert med frilansoppdrag i AA-registeret må du be de som har gjort registreringen om å oppdatere informasjonen. Du kan likevel fortsette å fylle ut og sende inn søknaden.',
