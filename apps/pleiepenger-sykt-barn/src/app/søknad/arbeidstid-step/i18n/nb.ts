export const arbeidIPeriodeMessages_nb = {
    'arbeidIPeriode.spørsmål.ANSATT.arbeiderIPerioden': 'Hvilken situasjon gjelder for deg {hvor} i søknadsperioden?',
    'arbeidIPeriode.spørsmål.ANSATT.erLiktHverUke': 'Jobber du like mye hver uke {hvor} i perioden?',
    'arbeidIPeriode.spørsmål.ANSATT.timerEllerProsent': 'Hvordan vil du oppgi hvor mye du jobber {hvor} i perioden?',
    ...
    'arbeidIPeriode.validation.prosentAvNormalt.numberHasNoValue': 'Du må oppgi hvor mange prosent du jobber {hvor}.',
