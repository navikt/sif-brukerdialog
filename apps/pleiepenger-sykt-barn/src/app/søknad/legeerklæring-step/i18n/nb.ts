...
export const legeerklæringMessages_nb = {
    ...
    'steg.legeerklaering.counsellorpanel.1':
        'Her skal du laste opp legeerklæringen. Det gjør du enten ved å ta bilde av legeerklæringen, eller ved å skanne den. Vennligst sjekk at bildet du laster opp er av god kvalitet slik at all tekst er leselig.',
