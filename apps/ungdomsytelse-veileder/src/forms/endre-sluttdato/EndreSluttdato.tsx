...
import { Oppgave, OppgaveEndretSluttdato, Oppgavetype } from '@navikt/ung-common';
...
const EndreSluttdato = ({ deltakelse, deltakelser, deltakernavn, oppgaver, onChange }: Props) => {
    ...
    ) as OppgaveEndretSluttdato[];

    const åpenOppgave: OppgaveEndretSluttdato | undefined = åpneOppgaver.length > 0 ? åpneOppgaver[0] : undefined;
