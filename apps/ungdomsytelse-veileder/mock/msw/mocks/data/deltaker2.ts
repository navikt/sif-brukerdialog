...
const deltakerPersonalia: VeilederApi.DeltakerPersonalia = {
    ...
    diskresjonskoder: [VeilederApi.Diskresjonskode.SKJERMET, VeilederApi.Diskresjonskode.KODE6],
};
...
const historikk: VeilederApi.DeltakelseHistorikkDto[] = [
    {
    ...
    },
    {
        ...
        endringstype: VeilederApi.Endringstype.ENDRET_STARTDATO,
        revisjonstype: VeilederApi.Revisjonstype.ENDRET,
    ...
    },
    {
        ...
        endringstype: VeilederApi.Endringstype.ENDRET_SLUTTDATO,
        revisjonstype: VeilederApi.Revisjonstype.ENDRET,
