...
if (globalThis.location.pathname === '/') {
    globalThis.location.pathname = '/aktivitetspenger/soknad';
}
                                ...
                                contentRenderer={() => (
                                    <SifGuidePanel mood="happy" title="Vi utfører vedlikehold" poster={true}>
                                        <BodyShort className="pt-4" size="large">
                                            Sidene for aktivitetspenger er midlertidig utilgjengelige. Vi regner med å
