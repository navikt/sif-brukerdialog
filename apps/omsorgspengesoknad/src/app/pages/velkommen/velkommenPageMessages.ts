const nb = {
    ...
    'page.velkommen.personopplysninger.utvidTittel': 'Om hvordan vi innhenter opplysninger om deg',
    ...
    'page.velkommen.personopplysninger.4.2': 'opplysninger om barnets helse',
    'page.velkommen.personopplysninger.4.3': 'arbeidsforholdene dine og inntekten din',
    'page.velkommen.personopplysninger.4.4': 'ytelser du mottar fra NAV',
    'page.velkommen.personopplysninger.4.5': 'tilknytningen din til Norge',
...
const nn: Record<keyof typeof nb, string> = {
    ...
    'page.velkommen.guide.tekst.2':
        'Viss fleire skal ha ekstra omsorgsdagar for same barn, må de sende kvar dykkar søknad til NAV.',
    'page.velkommen.guide.tekst.3':
        'Viss du har fått godkjent søknaden av NAV, treng du ikkje å søkje om ekstra omsorgsdagar igjen. Vedtak om ekstra dagar varer til barnet blir 18 år.',
    'page.velkommen.omSøknaden.tittel': 'Om søknaden',
    'page.velkommen.omSøknaden.1': 'Du får rettleiing undervegs i søknaden om kva du skal fylle ut, og korleis.',
    'page.velkommen.omSøknaden.fremoverITid':
        'Viss du søkjer fram i tid, har vi forståing for at du kan bli usikker på kva du skal svare på nokre spørsmål som handlar om tida framover. Då svarar du så godt du kan ut frå kva situasjonen er no, og så kan du melde frå om eventuelle endringar seinare.',
    'page.velkommen.omSøknaden.2':
        'Vi tar vare på svara dine i 72 timar. Viss du innanfor den tida til dømes vil ta ein pause eller blir automatisk logga ut, fortset du der du var når du kjem tilbake.',
    'page.velkommen.omSøknaden.3':
    ...
    'page.velkommen.omSøknaden.4': 'Om korleis vi innhentar opplysningar om deg',
    'page.velkommen.personopplysninger.utvidTittel': 'Om korleis vi innhentar opplysningar om deg',
    'page.velkommen.personopplysninger.1': 'Slik behandlar NAV personopplysningane dine',
    'page.velkommen.personopplysninger.2':
        'Vi innhentar og mottar opplysningar om deg for å behandle saka di. Det er nødvendig for at du skal få rett teneste. Delar av saka di blir behandla automatisk.',
    'page.velkommen.personopplysninger.3': 'Kva for opplysningar innhentar vi?',
    'page.velkommen.personopplysninger.4':
        'Opplysningane vi innhentar kjem anten frå deg eller frå offentlege register:',
    'page.velkommen.personopplysninger.4.1': 'kva for barn du er registrert som forelder til',
    'page.velkommen.personopplysninger.4.2': 'opplysningar om barnet sin helse',
    'page.velkommen.personopplysninger.4.3': 'arbeidsforholda dine og inntekta di',
    'page.velkommen.personopplysninger.4.4': 'ytelsar du mottar frå NAV',
    'page.velkommen.personopplysninger.4.5': 'tilknytinga di til Noreg',
    'page.velkommen.personopplysninger.4.6':
