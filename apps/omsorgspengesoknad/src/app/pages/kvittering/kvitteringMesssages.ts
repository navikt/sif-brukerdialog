const nb = {
    ...
    'page.kvittering.info.2': 'Hvis du ikke har lastet opp legeerklæring, må du ettersende den så snart som mulig. ',
...
const nn: Record<keyof typeof nb, string> = {
    ...
    'page.kvittering.tittel':
        'Vi har motteke søknad om ekstra omsorgsdagar for barn som har kronisk/langvarig sjukdom eller funksjonshemning',
    'page.kvittering.info.tittel': 'Kva skjer vidare no?',
    'page.kvittering.info.1': 'Vi behandlar søknaden din.',
    'page.kvittering.info.2': 'Viss du ikkje har lasta opp legeerklæring, må du ettersende den så snart som mogleg.',
    'page.kvittering.info.3': 'Vi kontaktar deg viss vi treng fleire opplysningar.',
    'page.kvittering.info.4.1': 'Når søknaden er ferdigbehandla, får du eit svar frå oss på «Min side».',
    'page.kvittering.info.4.2': 'Du kan sjekke saksbehandlingstida her.',
};
