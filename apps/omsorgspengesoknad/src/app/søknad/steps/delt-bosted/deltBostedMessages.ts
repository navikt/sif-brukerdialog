...
export const deltBostedMessages: MessageFileFormat = {
    nb: {
        ...
        'steg.deltBosted.helperTextPanel.1':
            'For å få ekstra omsorgsdager må du bo sammen med barnet. Du har opplyst om at dere har avtale om delt fast bosted. Hvis barnet ikke er folkeregistrert på din adresse, må du sende inn avtalen om delt bosted. Du laster opp avtalen enten ved å ta bilde av den, eller ved å skanne den.',
