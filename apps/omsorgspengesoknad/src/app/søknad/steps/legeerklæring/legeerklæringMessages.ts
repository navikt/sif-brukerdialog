...
export const legeerklæringMessages: MessageFileFormat = {
    nb: {
        'steg.legeerklaering.stepIndicatorLabel': 'Last opp din legeerklæring',
        'steg.legeerklaering.nextButtonLabel': 'Fortsett',
        ...
        'steg.legeerklaering.counsellorpanel.ettersendLenke':
