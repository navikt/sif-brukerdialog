...
export const getAppEnv = (): AppEnv => ({
    ...
    SIF_PUBLIC_FEATURE_SLETT_SLUTTDATO: getMaybeEnv('SIF_PUBLIC_FEATURE_SLETT_SLUTTDATO') || 'off',
    SIF_PUBLIC_FEATURE_SLETT_AKTIV_DELTAKELSE: getMaybeEnv('SIF_PUBLIC_FEATURE_SLETT_AKTIV_DELTAKELSE') || 'off',
    SIF_PUBLIC_TILLAT_TIDLIG_INNMELDING: getMaybeEnv('SIF_PUBLIC_TILLAT_TIDLIG_INNMELDING') || 'off',
    ...
    SIF_PUBLIC_VIS_DEV_INFO: getMaybeBoolEnv('SIF_PUBLIC_VIS_DEV_INFO'),
