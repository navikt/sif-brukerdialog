...
export enum Service {
    ...
    UNG_BRUKERDIALOG_API = 'UNG_BRUKERDIALOG_API',
}
...
const proxies = {
    ...
    [Service.UNG_BRUKERDIALOG_API]: <Proxy>{
        frontendPath: process.env[ProxyEnvKey.UNG_BRUKERDIALOG_API_FRONTEND_PATH],
        apiScope: process.env[ProxyEnvKey.UNG_BRUKERDIALOG_API_API_SCOPE],
        apiUrl: process.env[ProxyEnvKey.UNG_BRUKERDIALOG_API_API_URL],
    },
};
