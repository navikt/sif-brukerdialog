...
**Note**: Tokens only need to be installed separately if the package `@navikt/ds-css` is not used, or project needs tokens in format: Javascript, SCSS or Less.
...
| Agent                  | Use For                                              |
| ---------------------- | ---------------------------------------------------- |
| `Explore`              | Fast read-only exploration for patterns and examples |
| `aksel-frontend-agent` | Frontend implementation with Aksel in this monorepo  |
| `accessibility-agent`  | WCAG/accessibility review for components and flows   |
