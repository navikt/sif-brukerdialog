...
- `sif-skyra`:
    - Skyra-oppsett: `skyra`, `skyra-survey`, `SkyraHandler`, `useSkyraReloader`, `SkyraTestPage`, `slug`.
...
- Hvis oppgaven handler om Skyra (`skyra-survey`, slug/reload/testside), prioriter `sif-skyra`.
