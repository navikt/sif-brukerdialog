...
-   `yarn dev` - Bygger alle moduler under packages, og starter watch på alle packages. Initiell `yarn build` bør kjøres først.
...
-   Dersom det gjøres større endringer i en package, kan det være en må kjøre `yarn build` manuelt for at applikasjonen skal få det med seg. I VS Code kan det være en må kjøre "reload windows".
