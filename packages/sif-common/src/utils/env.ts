...
const apiEnvSchema = z.object({
    BRUKERDIALOG_PROSESSERING_FRONTEND_PATH: z.string(),
...
const apiEnv = apiEnvSchema.parse({
    BRUKERDIALOG_PROSESSERING_FRONTEND_PATH: getMaybeEnvironmentVariable('BRUKERDIALOG_PROSESSERING_FRONTEND_PATH'),
