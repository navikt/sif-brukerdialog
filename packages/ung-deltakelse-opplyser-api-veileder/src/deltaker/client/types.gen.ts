...
export type OppgaveDto = {
    ...
    oppgavetypeData: EndretSluttdatoDataDto | EndretStartdatoDataDto | InntektsrapporteringOppgavetypeDataDto | KontrollerRegisterinntektOppgavetypeDataDto | SøkYtelseOppgavetypeDataDto;
