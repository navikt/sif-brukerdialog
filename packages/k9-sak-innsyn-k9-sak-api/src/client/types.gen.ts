...
export type ClientOptions = {
    baseURL: 'https://k9-sak-innsyn-api.intern.nav.no' | (string & {});
};
...
export type HentAktiveOpplæringsinstitusjonerError = HentAktiveOpplæringsinstitusjonerErrors[keyof HentAktiveOpplæringsinstitusjonerErrors];
...
export type HentAktiveOpplæringsinstitusjonerResponse = HentAktiveOpplæringsinstitusjonerResponses[keyof HentAktiveOpplæringsinstitusjonerResponses];
