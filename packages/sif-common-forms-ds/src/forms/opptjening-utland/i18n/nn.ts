...
export const opptjeningUtlandMessages_nn: Record<OpptjeningUtlandMessageKeys, string> = {
    ...
    '@forms.opptjeningUtland.form.arbeidsgiversNavn': 'Skriv inn namnet på arbeidsgjevaren',
    '@forms.opptjeningUtland.form.oppdragsgiverNavn': 'Skriv inn namnet på oppdragsgjevaren',
    ...
    '@forms.opptjeningUtlandForm.fom.dateHasInvalidFormat':
        'Du må oppgje dato når du starta å jobba i eit gyldig format. Gyldig format er dd.mm.åååå.',
    ...
    '@forms.opptjeningUtlandForm.tom.dateIsAfterMax': 'Du har lagt inn ein jobb som er utanfor søknadsperioden.',
    ...
    '@forms.opptjeningUtlandForm.type.noValue': 'Du må velja kva du jobba som.',
    ...
    '@forms.opptjeningUtlandForm.opptjeningType.noValue': 'Du må oppgje kva du jobba som.',
};
