...
export const medlemskapFormMessages_nn: Record<MedlemskapFormMessageKeys, string> = {
    '@forms.medlemskapForm.annetLandSiste12.spm':
        'Har du budd i utlandet i heile eller deler av dei siste 12 månadane?',
    '@forms.medlemskapForm.annetLandNeste12.spm':
        'Planlegg du å bu i utlandet i heile eller deler av dei neste 12 månadane?',
    ...
    '@forms.medlemskapForm.annetLandSiste12.listeTittel': 'Utanlandsopphald siste 12 månadar',
    ...
    '@forms.medlemskapForm.annetLandNeste12.listeTittel': 'Utanlandsopphald neste 12 månadar',
    '@forms.medlemskapForm.annetLandSisteOgNeste12.listeTittel':
        'Utanlandsopphald siste 12 månadar og neste 12 månadar',
    ...
    '@forms.medlemskapForm.validation.harBoddUtenforNorgeSiste12Mnd.yesOrNoIsUnanswered':
        'Du må svara på om du har budd i utlandet i heile eller deler av dei siste 12 månadane.',
    '@forms.medlemskapForm.validation.utenlandsoppholdSiste12Mnd.utenlandsopphold_ikke_registrert':
        'Du har ikkje registrert nokon utanlandsopphald for dei siste 12 månadane.',
    ...
    '@forms.medlemskapForm.validation.utenlandsoppholdSiste12Mnd.utenlandsopphold_utenfor_periode':
        'Eitt eller fleire av utanlandsopphalda dei siste 12 månadane er utanfor tillatne tidsrom.',
    '@forms.medlemskapForm.validation.skalBoUtenforNorgeNeste12Mnd.yesOrNoIsUnanswered':
        'Du må svara på om du planlegg å bu i utlandet i heile eller deler av dei neste 12 månadane.',
    '@forms.medlemskapForm.validation.utenlandsoppholdNeste12Mnd.utenlandsopphold_ikke_registrert':
        'Du har ikkje registrert nokon utanlandsopphald for dei neste 12 månadane.',
    ...
    '@forms.medlemskapForm.validation.utenlandsoppholdNeste12Mnd.utenlandsopphold_utenfor_periode':
        'Eitt eller fleire av utanlandsopphalda dei neste 12 månadane er utanfor tillatne tidsrom.',
    '@forms.medlemskapForm.summary.header': 'Medlemskap i folketrygda',
    '@forms.medlemskapForm.summary.utlandetSiste12.header': 'Har budd i utlandet i dei siste 12 månadane',
    '@forms.medlemskapForm.summary.utlandetNeste12.header': 'Skal bu i utlandet i dei neste 12 månadane',
    '@forms.medlemskapForm.summary.utlandetSiste12.liste.header': 'Utanlandsopphald siste 12 månadar',
    '@forms.medlemskapForm.summary.utlandetNeste12.liste.header': 'Utanlandsopphald neste 12 månadar',
