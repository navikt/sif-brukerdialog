...
} from './EndretStartOgSluttdatoOppgavePanel.mockData';

const meta: Meta = {
    title: 'Oppgaver/3. Ungdomsprogramytelsen/Endret start og sluttdato',
    ...
    render: () => (
        <VStack gap="space-40">
            <VStack gap="space-16">
                ...
                <OppgaverList oppgaver={[mockEndretStartOgSluttdatoUPY]} />
            </VStack>
            <VStack gap="space-16">
                <Heading level="2" size="medium">
                    Løste oppgaver
                ...
                <OppgaverList
                    ...
                    oppgaver={[
                        { ...mockEndretStartOgSluttdatoUPY, status: OppgaveStatus.AVBRUTT },
                        { ...mockEndretStartOgSluttdatoUPY, status: OppgaveStatus.UTLØPT },
                        { ...mockEndretStartOgSluttdatoUPY, status: OppgaveStatus.LØST },
                    ]}
                />
            </VStack>
        </VStack>
...
export const Kvittering: Story = {
    ...
    render: () => (
        <EndretStartOgSluttdatoOppgavePanel
            oppgave={mockEndretStartOgSluttdatoUPY}
            navn="SNODIG VAFFEL"
...
export const Utløpt: Story = {
    ...
    render: () => (
        <EndretStartOgSluttdatoOppgavePanel
            oppgave={{ ...mockEndretStartOgSluttdatoUPY, status: OppgaveStatus.UTLØPT, løstDato: new Date() }}
            navn="SNODIG VAFFEL"
        />
    ),
};
...
export const Avbrutt: Story = {
    ...
    render: () => (
        <EndretStartOgSluttdatoOppgavePanel
            oppgave={{ ...mockEndretStartOgSluttdatoUPY, status: OppgaveStatus.AVBRUTT, løstDato: new Date() }}
            navn="SNODIG VAFFEL"
        />
    ),
};
