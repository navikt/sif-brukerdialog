export const bostedVilkårMessages_nb = {
    '@ungInnsyn.bostedVilkårOppgave.tekst.1': 'Veilederen mener du ikke lenger bor i Trondheim.',
    ...
    '@ungInnsyn.bostedVilkårOppgave.tekst.4':
        'Har du en tilbakemelding? Ta kontakt med veilederen din først. Når dere har snakket sammen, sender du inn svaret ditt her.',
    '@ungInnsyn.bostedVilkårOppgave.tekst.5': 'Fristen for å svare er senest {formatertFrist}.',
    '@ungInnsyn.bostedVilkårOppgave.tekst.6': 'Hvis vi ikke hører fra deg innen svarfristen har gått ut, vil ...',
    '@ungInnsyn.bostedVilkårOppgave.oppsummering': 'Veileder har registrert at du ikke bor i Trondheim lenger.',
};
