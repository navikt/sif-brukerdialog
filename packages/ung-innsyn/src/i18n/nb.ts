...
export const ungUi_messages_nb = {
    ...
    '@ungUi.loading': 'Laster...',
    '@ungUi.errorPage': 'Det oppstod en feil',
    '@ungUi.defaultErrorMessage.heading': 'Oops, noe gikk galt',
    '@ungUi.defaultErrorMessage.message': 'Det oppstod en feil. Vennligst prøv igjen senere.',
