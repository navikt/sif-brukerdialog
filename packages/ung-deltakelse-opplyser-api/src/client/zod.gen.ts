...
export const zDeltakelseOpplysningDto = z.object({
    ...
    'harSøkt': z.boolean(),
    oppgaver: z.array(z.object({
        id: z.string().uuid(),
        eksternReferanse: z.string().uuid(),
        oppgavetype: z.enum([
        ...
        oppgavetypeData: z.union([
            ...
            z.object({}).merge(z.object({
                ...
                registerinntekt: z.object({
                    ...
                    ytelseInntekter: z.array(z.object({
                        inntekt: z.number().int(),
                        ytelsetype: z.string()
                    })),
...
export const zEndretSluttdatoOppgavetypeDataDto = z.object({}).merge(z.object({
    nySluttdato: z.string().date(),
    veilederRef: z.string(),
    meldingFraVeileder: z.string().optional()
}));

export const zEndretStartdatoOppgavetypeDataDto = z.object({}).merge(z.object({
    nyStartdato: z.string().date(),
    veilederRef: z.string(),
    meldingFraVeileder: z.string().optional()
}));

export const zKontrollerRegisterinntektOppgavetypeDataDto = z.object({}).merge(z.object({
    fraOgMed: z.string().date(),
    tilOgMed: z.string().date(),
    registerinntekt: z.object({
        arbeidOgFrilansInntekter: z.array(zArbeidOgFrilansRegisterInntektDto),
...
export const zRegisterInntektDto = z.object({
    ...
    registerinntekterForYtelse: z.array(z.object({
        'beløp': z.number().int(),
        ytelseType: z.string()
    })).optional()
});
...
export const zDeltakelsePeriodInfo = z.object({
    ...
    rapporteringsPerioder: z.array(z.object({
        fraOgMed: z.string().date(),
        tilOgMed: z.string().date(),
