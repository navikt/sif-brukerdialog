...
function FormikTextarea(_a) {
    var { name, validate, error, useFastField } = _a, restProps = __rest(_a, ["name", "validate", "error", "useFastField"]);
    ...
    return (react_1.default.createElement(FieldComponent, { validate: validate ? (value) => validate(value, name) : undefined, name: name }, ({ field, form }) => {
        return (react_1.default.createElement(ds_react_1.Textarea, Object.assign({}, restProps, field, { error: (0, typedFormErrorUtils_1.getErrorPropForFormikInput)({ field, form, context, error }), onChange: (evt) => {
