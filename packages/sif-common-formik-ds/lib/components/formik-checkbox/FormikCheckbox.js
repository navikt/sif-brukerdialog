...
function FormikCheckbox(_a) {
    var { name, label, validate, afterOnChange, error, useFastField } = _a, restProps = __rest(_a, ["name", "label", "validate", "afterOnChange", "error", "useFastField"]);
    ...
    return (react_1.default.createElement(FieldComponent, { validate: validate ? (value) => validate(value, name) : undefined, name: name }, ({ field, form }) => {
        const hasError = (0, typedFormErrorUtils_1.getErrorPropForFormikInput)({ field, form, context, error });
        return (react_1.default.createElement(ds_react_1.Checkbox, Object.assign({}, restProps, field, { error: hasError !== undefined, checked: field.value === true, autoComplete: "off", onChange: (evt) => {
