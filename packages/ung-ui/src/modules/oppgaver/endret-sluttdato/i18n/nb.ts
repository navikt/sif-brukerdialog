export const endretSluttdatoMessages_nb = {
    ...
    '@ungUi.endretSluttdato.oppgavetekst.4':
        'Har du en tilbakemelding? Ta kontakt med veilederen din først. Når dere har snakket sammen, sender du inn svaret ditt her.',
    '@ungUi.endretSluttdato.oppgavetekst.svarfrist': 'Fristen for å svare er senest {formatertFrist}.',
    '@ungUi.endretSluttdato.oppgavetekst.5':
    ...
    '@ungUi.endretSluttdato.oppsummering.endret':
