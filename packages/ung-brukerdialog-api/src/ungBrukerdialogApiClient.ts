import { EnvKey, getUngBrukerdialogApiBrowserEnv } from '@navikt/sif-common-env';
...
export const initUngBrukerdialogApiClient = (options?: InitOptions) => {
    ...
    client.setConfig({
        ...
        baseURL: `${apiBaseUrl}${getUngBrukerdialogApiBrowserEnv()[EnvKey.UNG_BRUKERDIALOG_API_FRONTEND_PATH]}`,
    });
