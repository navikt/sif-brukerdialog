...
export class PleiepengerSyktBarnControllerService {
    public static innsending1<ThrowOnError extends boolean = false>(options: Options<Innsending1Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending1Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class EndringsmeldingControllerService {
    public static innsending2<ThrowOnError extends boolean = false>(options: Options<Innsending2Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending2Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class PleiepengerLivetsSluttfaseControllerService {
    public static innsending3<ThrowOnError extends boolean = false>(options: Options<Innsending3Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending3Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class OpplÆringspengerSØknadControllerService {
    public static innsending4<ThrowOnError extends boolean = false>(options: Options<Innsending4Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending4Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class OmsorgspengerUtvidetRettControllerService {
    public static innsending5<ThrowOnError extends boolean = false>(options: Options<Innsending5Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending5Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class OmsorgspengerUtbetalingSnfControllerService {
    public static innsending6<ThrowOnError extends boolean = false>(options: Options<Innsending6Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending6Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class OmsorgspengerUtbetalingArbeidstakerControllerService {
    public static innsending7<ThrowOnError extends boolean = false>(options: Options<Innsending7Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending7Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class OmsorgspengerMidlertidigAleneControllerService {
    public static innsending8<ThrowOnError extends boolean = false>(options: Options<Innsending8Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending8Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class OmsorgsdagerAleneomsorgControllerService {
    public static innsending9<ThrowOnError extends boolean = false>(options: Options<Innsending9Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending9Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
...
export class EttersendingControllerService {
    public static innsending10<ThrowOnError extends boolean = false>(options: Options<Innsending10Data, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, Innsending10Error, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http',
