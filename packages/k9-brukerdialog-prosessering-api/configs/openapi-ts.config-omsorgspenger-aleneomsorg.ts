...
const getInputUrl = (env: Env): string => {
    return `https://k9-brukerdialog-prosessering.${getEnvBaseUrl(env)}/v3/api-docs/omsorgspenger-aleneomsorg`;
};
...
export const createConfig = (env: Env): UserConfig => ({
    ...
    output: {
        format: 'prettier',
        lint: 'eslint',
        path: './src/generated/omsorgspenger-aleneomsorg', // Separat mappe
    },
    plugins: [
        {
