...
export const virksomhetMessages_nn: Record<keyof typeof virksomhetMessages_nb, string> = {
    ...
    '@sifSoknadForms.virksomhet.form.registrertINorge.legend': 'Er {namn} registrert i Noreg?',
    ...
    '@sifSoknadForms.virksomhet.form.veileder_fisker':
        'Viss du ikkje har organisasjonsnummer, svarer du nei på spørsmålet "Er {namn} registrert i Noreg?" I nedtrekkslista vel du at verksemda er registrert i Noreg.',
    '@sifSoknadForms.virksomhet.form.registrertILand.label': 'I kva land er {namn} registrert?',
    '@sifSoknadForms.virksomhet.form.organisasjonsnummer.label': 'Kva er organisasjonsnummeret?',
    '@sifSoknadForms.virksomhet.form.tidsperiode.legend': 'Når starta du {namn}?',
