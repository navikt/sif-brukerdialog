export const utenlandsoppholdMessages_nb = {
    '@sifSoknadForms.utenlandsopphold.dialog.tittel': 'Utenlandsopphold',
    ...
    '@sifSoknadForms.utenlandsopphold.form.tidsperiode.legend': 'Velg tidsperiode for oppholdet',
    '@sifSoknadForms.utenlandsopphold.form.fom.label': 'Fra og med',
    '@sifSoknadForms.utenlandsopphold.form.tom.label': 'Til og med',
    '@sifSoknadForms.utenlandsopphold.form.land.label': 'Velg land',
    '@sifSoknadForms.utenlandsopphold.form.erSammenMedBarnet.legend': 'Er barnet sammen med deg til {land}?',
    '@sifSoknadForms.utenlandsopphold.form.erBarnetInnlagt.legend': 'Er barnet innlagt i helseinstitusjon i {land}?',
    '@sifSoknadForms.utenlandsopphold.form.barnInnlagtPerioder.legend': 'Periode(r) barnet er innlagt',
    '@sifSoknadForms.utenlandsopphold.form.barnInnlagtPerioder.leggTil': 'Legg til periode barnet er innlagt',
    '@sifSoknadForms.utenlandsopphold.form.årsak.legend': 'Hvordan dekkes utgiftene til innleggelsen?',
    ...
    '@sifSoknadForms.utenlandsoppholdForm.validation.erSammenMedBarnet.yesOrNoIsUnanswered':
        'Du må svare ja eller nei på om barnet er sammen med deg til {land}.',
