export const utenlandskNæringMessages_nb = {
    '@sifSoknadForms.utenlandskNæring.dialog.tittel': 'Opplysninger om virksomheten',
    ...
    '@sifSoknadForms.utenlandskNæring.form.næringstype.legend': 'Hvilken type virksomhet hadde du?',
    '@sifSoknadForms.utenlandskNæring.form.næringstype.FISKE': 'Fisker',
    '@sifSoknadForms.utenlandskNæring.form.næringstype.JORDBRUK_SKOGBRUK': 'Jordbruker',
    '@sifSoknadForms.utenlandskNæring.form.næringstype.DAGMAMMA': 'Dagmamma eller familiebarnehage i eget hjem',
    '@sifSoknadForms.utenlandskNæring.form.næringstype.ANNEN': 'Annet',
    '@sifSoknadForms.utenlandskNæring.form.navnPåVirksomheten.label': 'Skriv inn navnet på virksomheten',
    '@sifSoknadForms.utenlandskNæring.form.land.label': 'I hvilket land var {navn} registrert i?',
    ...
    '@sifSoknadForms.utenlandskNæring.form.tidsperiode.legend': 'Når startet du {navn}?',
