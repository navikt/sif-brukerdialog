export const bostedUtlandMessages_nb = {
    ...
    '@sifSoknadForms.bostedUtland.form.fom.label': 'Fra og med',
    '@sifSoknadForms.bostedUtland.form.tom.label': 'Til og med',
    '@sifSoknadForms.bostedUtland.form.land.label': 'Velg land',
    ...
    '@sifSoknadForms.bostedUtlandForm.validation.landkode.noValue': 'Du må velge land',
};
