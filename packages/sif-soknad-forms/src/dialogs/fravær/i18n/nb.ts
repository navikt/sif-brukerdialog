export const fraværMessages_nb = {
    ...
    '@sifSoknadForms.fraværPeriodeForm.validation.fraOgMed.dateIsBeforeMin':
        'Datoen for når perioden startet kan ikke være før {dato}. Skriv inn eller velg dato fra datovelgeren.',
    ...
    '@sifSoknadForms.fraværPeriodeForm.validation.fraværPeriode.dager_overlapper_med_andre_dager':
        'Perioden overlapper med allerede registrert fravær.',
    '@sifSoknadForms.fraværDagForm.validation.dato.dateHasNoValue':
        'Du må oppgi dato for når du hadde delvis fravær. Skriv inn eller velg dato fra datovelgeren.',
    ...
    '@sifSoknadForms.fraværDagForm.validation.timerArbeidsdag.noValue':
        'Du må velge antall timer du skulle ha jobbet denne dagen.',
    '@sifSoknadForms.fraværDagForm.validation.timerFravær.noValue':
        'Du må velge antall timer du var borte fra jobb denne dagen.',
