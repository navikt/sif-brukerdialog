export const velgRegistrertBarnPanelMessages_nb = {
    '@sifSoknadForms.velgRegistrertBarn.legend': 'Barn registrert på deg',
    '@sifSoknadForms.velgRegistrertBarn.gjelderAnnetBarn': 'Søknaden gjelder et annet barn',
    '@sifSoknadForms.velgRegistrertBarn.født': 'Født {dato}',
